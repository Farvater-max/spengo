...
export function ShareModal({ sharedUsers = [], loading = false, accessUrl = null, onShare, onRemove, onClose }) {
    ...
    const btnBase = {
        ...
        boxShadow:      btnHover && canSubmit ? '0 8px 32px var(--color-accent-hover)' : 'none',
    ...
    return (
        <button
            ...
            style={{
                ...
                height:         '32px',
                borderRadius:   'var(--r-sm)',
                border:         copied ? '1px solid var(--color-accent-border)' : '1px solid var(--border)',
                background:     copied ? 'var(--color-accent-soft)'           : 'var(--surface)',
                cursor:         'pointer',
                display:        'flex',
                alignItems:     'center',
                justifyContent: 'center',
